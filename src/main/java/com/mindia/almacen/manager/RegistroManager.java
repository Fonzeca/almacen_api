...
public class RegistroManager {
	...
	public void createRegistro(boolean entrada, int user, TIPO_REGISTRO tipo, int idEntidad, Usuario encargado) {
		...
		// Se le setea el encargado, el cual puede ser nulo
		registro.setUsuarioByEncargado(encargado);
